...
//Declaring two global variables that indicates the cursor position according to each line and cell
//u8 LINE1_Cell=1;
//u8 Line2_CELL=1;
...
void LCD_Init(void)
{
	...
	LCD_Instruction(0x0c); //0x0e,0x0f
...
void LCD_GoTo(u8 line, u8 cell)
{
	...
	{
		LCD_Instruction(0x80+0x40+cell);
	}
}
